...
(define-public node-commonmark-0.29.3
  (package
    ...
    (source
      (origin
        (method url-fetch)
        (uri "https://registry.npmjs.org/commonmark/-/commonmark-0.29.3.tgz")
        (sha256
          (base32
            "0cw93a7dzxdls621vnxjc05rpmkk1xq59smlbg4amr9354xh7rdb"))))
    (build-system node-build-system)
    (arguments
      `(#:tests?
        #f
...
(package
  ...
  (inputs
    `(("node-vue" ,node-vue-3.0.11)
      ...
      ("node-commonmark" ,node-commonmark-0.29.3)))
  (native-inputs
   `(("esbuild" ,esbuild)
