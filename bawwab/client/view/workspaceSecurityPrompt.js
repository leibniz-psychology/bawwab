...
export default {
	props: ['wsid'],
	template: `<modal icon="users" :title="t('title')" :closeLink="{name: 'workspace', params: {wsid: workspace?.metadata._id}}" :scaling="true">
	...
	data: _ => ({
		...
		strings: translations({
			de: {
				...
				'title': 'Jemand hat Kopierrechte für ein Projekt mit dir geteilt!',
				'explainLink': 'Was heißt das?',
				'warning': 'Bitte kopiere dieses Projekt nur, wenn du die teilende Person kennst und ihr vertraust!',
			...
			en: {
				...
				'title': 'Someone shared copy rights for a project with you!',
				'explainLink': 'What does that mean?',
				'warning': 'Please only copy this project if you know and trust the person sharing it!',
	...
	methods: {
		saveSettings: async function () {
			if (!this.isOwnWorkspace && this.autocopySharedReadOnly) {
